...
public class Generate_Reports extends UtilitiesLib{
	...
	public static String createResultFolder()
	{
		...
		File f=new File(System.getProperty("user.dir")+"\\Results\\"+sdf.format(new Date()).replace("/", "")+"\\TestSummaryReport.html");
