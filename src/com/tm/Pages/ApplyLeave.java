...
public class ApplyLeave extends Weblibrary{
	...
	// Leave type Webelement
		...
		public void applyLeav1(String drpdwn,String frmdate,String thrudate, String comment) {
			boolean status;

			wait(1);
			status = selectByText(drp_LeaveType, drpdwn);
			...
			wait(1);
			status = setText(txt_comment, comment);
