...
import com.tm.reporting.Generate_Reports;
...
public class Weblibrary extends DriverClass {
	...
	public static boolean selectbyName(WebElement xpath,String name) {
		boolean status = false;
		try {
		
		List<WebElement> options = xpath.findElements(By.tagName(name));
